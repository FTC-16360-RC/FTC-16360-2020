...
@Disabled
@Autonomous(name="Skystones Blue", group="Iterative Opmode")
public class DoubleSkystonesBlue extends OpMode
{
    ...
    public void init() {
        ...
        autoControl.setAutoMode(AutoControl.AutoMode.DOUBLE_SKYSTONES_BLUE);
    }
