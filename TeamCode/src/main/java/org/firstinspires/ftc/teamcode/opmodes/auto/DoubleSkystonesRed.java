...
@Disabled
@Autonomous(name="Skystones Red", group="Iterative Opmode")
public class DoubleSkystonesRed extends OpMode
{
    ...
    public void init() {
        ...
        autoControl.setAutoMode(AutoControl.AutoMode.DOUBLE_SKYSTONES_RED);
    }
