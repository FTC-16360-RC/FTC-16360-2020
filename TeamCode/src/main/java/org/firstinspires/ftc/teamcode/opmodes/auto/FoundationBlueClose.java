...
@Disabled
@Autonomous(name="Foundation Blue Close", group="Iterative Opmode")
public class FoundationBlueClose extends OpMode
{
    ...
    @Override
    public void init() {
        autoControl = new AutoControl(hardwareMap, false);
    ...
    public void start() {
        runtime.reset();
        autoControl.setAutoMode(AutoControl.AutoMode.FOUNDATION_BLUE_CLOSE);
        autoControl.start();
    }
