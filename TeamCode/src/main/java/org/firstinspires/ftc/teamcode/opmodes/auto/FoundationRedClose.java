...
@Disabled
@Autonomous(name="Founation Red Close", group="Iterative Opmode")
public class FoundationRedClose extends OpMode
{
    ...
    public void start() {
        runtime.reset();
        autoControl.setAutoMode(AutoControl.AutoMode.FOUNDATION_RED_CLOSE);
        autoControl.start();
    }
