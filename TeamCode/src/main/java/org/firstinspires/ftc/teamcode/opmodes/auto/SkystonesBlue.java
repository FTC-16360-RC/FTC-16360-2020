...
//@Disabled
@Autonomous(name="Skystone Blue", group="Iterative Opmode")
public class SkystonesBlue extends OpMode
{
    ...
    public void init() {
        ...
        autoControl.setAutoMode(AutoControl.AutoMode.SKYSTONES_BLUE);
    }
